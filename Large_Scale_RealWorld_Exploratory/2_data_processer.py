...
def process_GitHubRepoData():
    ...
    # 2. filter
    folder_path = 'GitHubRepoData/FDissues'
    FD_issues_data_path = 'GitHubRepoData/GitHub_issues.csv'
    filtered_FD_issues_data_path = 'GitHubRepoData/filtered_GitHub_issues.csv'
    # Utils.merge_all_csvs_under_a_folder(folder_path, FD_issues_data_path)
    FD_commits_data_path = 'GitHubRepoData/GitHub_commit.csv'
    filtered_FD_commits_data_path = 'GitHubRepoData/filtered_GitHub_commits.csv'
...
def process_SOData():
    ...
    folder_path = 'SOdata/SOdataList'
    merged_SO_data_path = 'SOdata/SO_data.csv'
    filtered_SO_data_path = 'SOdata/filtered_SO_data.csv'
...
def process_UserReviewData():
    UserReview_path = 'UserReviewData/UserReviews.csv'
    saved_negative_reviews_path = 'UserReviewData/saved_negative_reviews.csv'
    filtered_UserReview_path = 'UserReviewData/filtered_UserReviews.csv'
