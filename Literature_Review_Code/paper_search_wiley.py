...
def get_all_papers_from_Wiley(keywords_group1, keywords_group2, saved_path):
...
if __name__ == '__main__':
    ...
    get_all_papers_from_Wiley(keywords_group1, keywords_group2, saved_path='data/Wiley_Papers.csv')