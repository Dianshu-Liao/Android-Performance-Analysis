...
def process_GitHubRepoData():
    ...
    # 2. filter
    folder_path = 'data/GitHub_Repo_Data/FDissues'
    ...
    FD_commits_data_path = 'data/GitHub_Repo_Data/merged_csv_commit.csv'
...
def process_SOData():
    ...
    folder_path = 'data/SOdata/SOdataList'
    merged_SO_data_path = 'data/SOdata/SO_data.csv'
